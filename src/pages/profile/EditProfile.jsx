    ...
    <div className='body-edit-profile'>
      <div className='edit-profile'>
        ...
        <div className='group-profile'>
          ...
          <button style={{ cursor: 'pointer' }} className='edit-avata' onClick={() => setShowChangePhoto(true)}><b>{t('btn1')}</b></button>
        </div>
        ...
        <div className='group-3'>
          ...
          <div className='div-toogle'>
            ...
            <div className='toogle'>
              <button style={{ cursor: 'pointer' }} className={toogle === 'ON' ? 'ON' : 'OFF'} onClick={handleToogle} value={toogle === 'ON' ? true : false} name='isShow' onChange={handleChange}>
        ...
        <button style={{ cursor: 'pointer' }} className='btn-submit' onClick={handleSubmit}>{t('submit')}</button>
      </div>
