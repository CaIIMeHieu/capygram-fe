    ...
    <div className="body-edit-profile">
      <div className="edit-profile">
        ...
        <div className="group-profile">
            <img src={me.avatarUrl} alt="avata" />
          <div className="name">
            <p className="p1">
              <b>{me.fullname !== "" ? me.fullname : "Hanglazy"}</b>
            </p>
            <p className="p2">
              {me.username !== "" ? me.username : "Hangcute"}
            </p>
          </div>
          <button
            style={{ cursor: "pointer" }}
            className="edit-avata"
        ...
        <div className="group-2">
          ...
          <select style={{padding:'20px 20px 20px 30px;'}} value={profile.sex} onChange={handleChange} name="sex">
        ...
        <div className="group-3">
          ...
          <div className="div-toogle">
            ...
            <div className="toogle">
              <button
                style={{ cursor: "pointer" }}
                className={toogle === "ON" ? "ON" : "OFF"}
                onClick={handleToogle}
                value={toogle === "ON" ? true : false}
                name="isShow"
                onChange={handleChange}
              >
