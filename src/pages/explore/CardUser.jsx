  ...
  return (
    <div className='container'>
      ...
      <div className='bottom-card-user'>
        {
          isFollow === false ? (
            <button style={{ cursor: 'pointer' }} className='btn-follow' onClick={handleFollow}>
              <img src={addFriend} alt='follow' className='icon-follow' />
              {t('follow')}
            </button>
          ) : (
            <div className='isfollow'>
              <button style={{ cursor: 'pointer' }} className='btn-message' onClick={handleChat}>{t('message')}</button>
              <button style={{ cursor: 'pointer' }} className='btn-following' onClick={() => setShowUnfollow(true)}>{t('following')}</button>
            </div>
          )
        }
      </div>
