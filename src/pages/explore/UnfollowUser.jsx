  ...
  return (
    <div className='unfollow-container'>
      <div className='avatar'>
        ...
        <p style={{ cursor: 'pointer' }}>{t('unfollow')} <b> @{user.userName}</b></p>
      </div>
      <div className='item-unfollow border' >
        <p style={{ cursor: 'pointer' }} className='red' onClick={handleClickUnfollow}>{t('unfollow')}</p>
      </div>
      <div className='item-unfollow'>
        <p style={{ cursor: 'pointer' }} onClick={onCancel}>{t('cancel')}</p>
      </div>
    </div>
  )
}
